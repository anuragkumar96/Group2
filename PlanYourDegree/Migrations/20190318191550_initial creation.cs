        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DegreeReq_Course_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Course",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DegreeReq_Degree_DegreeId",
                        column: x => x.DegreeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DegreeTermReq_Course_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Course",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DegreeTermReq_DegreePlan_DegreePlanId",
                        column: x => x.DegreePlanId,
                        principalTable: "DegreePlan",
                        principalColumn: "DegreePlanId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DegreeTermReq_Term_TermId",
                        column: x => x.TermId,
                        principalTable: "Term",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DegreeReq_CourseId",
                table: "DegreeReq",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_DegreeReq_DegreeId",
                table: "DegreeReq",
                column: "DegreeId");

            migrationBuilder.CreateIndex(
                name: "IX_DegreeTermReq_CourseId",
                table: "DegreeTermReq",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_DegreeTermReq_DegreePlanId",
                table: "DegreeTermReq",
                column: "DegreePlanId");

            migrationBuilder.CreateIndex(
                name: "IX_DegreeTermReq_TermId",
                table: "DegreeTermReq",
                column: "TermId");
        }
